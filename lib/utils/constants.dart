...
const double defaultBigContentPadding = 16.0;
const double defaultMediumContentPadding = 12.0;
const double defaultSmallContentPadding = 10.0;
const double defaultDialogBorderRadius = 16.0;
